...
export function ProfileCardModal({
  ...
  // The caller keys this component by user id, so it remounts per profile and
  // the initial state above is already correct for the new user — no reset
  // pass needed here, just the fetch.
  useEffect(() => {
    let live = true;
