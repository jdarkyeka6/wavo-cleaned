...
const FEATURES = [
  ['Core messaging, Spaces and calls', true, true, true],
  ['Profile Studio + custom themes', false, true, true],
  ['Chat themes + bubble styles', false, true, true],
  ['Message effects + animated reactions', false, true, true],
  ['Chat folders + advanced search', false, true, true],
  ['Recurring messages + streak protection', false, true, true],
  ['Wavo Labs', false, true, true],
  ['AI chat summaries + Ask Wavo', false, false, true],
  ['Voice-note transcription', false, false, true],
  ['Space analytics + advanced roles', false, false, true],
  ['Scheduled Space announcements', false, false, true],
]
...
export default function PlanComparison() {
  ...
  const [meta, setMeta] = useState(() => ({ current: 'Free', premiumPrice: 'A$4.99/month', proPrice: 'A$14.99/month' }))
  ...
  return <>
    {createPortal(
      <button className="wpc-trigger" type="button" onClick={() => setOpen(true)}>
        ...
        <small>Free vs Premium vs Pro</small>
      </button>,
      host,
    )}
        ...
        <section className="wpc-modal" role="dialog" aria-modal="true" aria-labelledby="wpc-title">
          <header className="wpc-modal-head">
            ...
            <div>
              ...
              <p>See exactly what changes between Free, Premium and Pro.</p>
            </div>
          ...
          <div className="wpc-table-wrap">
            <div className="wpc-grid wpc-plan-heads">
              ...
              <div className={`wpc-plan-head ${currentKey === 'free' ? 'current' : ''}`}>
                <span className="wpc-plan-icon free"><Gem size={17}/></span>
                <strong>Free</strong><small>A$0</small>
            ...
            <div className="wpc-rows">
              {FEATURES.map(([label, free, premium, pro]) => <div className="wpc-grid wpc-row" key={label}>
          ...
          <footer className="wpc-footer">
            <span><Crown size={14}/> Pro includes everything in Premium.</span>
